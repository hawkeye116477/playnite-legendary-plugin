...
{
    [ObservableProperty]
    public partial bool ImportInstalledGames { get; set; } = LegendaryLauncher.IsInstalled;
    ...
    [ObservableProperty]
    public partial bool ImportUbisoftLauncherGames { get; set; } = false;

    [ObservableProperty]
    public partial bool ImportEaLauncherGames { get; set; } = false;

    [ObservableProperty]
    public partial string SelectedFullLauncherPath { get; set; } = "";

    [ObservableProperty]
    public partial string GamesInstallationPath { get; set; } = "";

    [ObservableProperty]
    public partial bool LaunchOffline { get; set; } = false;

    [ObservableProperty]
    public partial string PreferredCdn { get; set; } = "";

    [ObservableProperty]
    public partial bool NoHttps { get; set; } = false;

    [ObservableProperty]
    public partial bool SyncGameSaves { get; set; } = false;

    [ObservableProperty]
    public partial int MaxWorkers { get; set; } = 0;

    [ObservableProperty]
    public partial int MaxSharedMemory { get; set; } = 0;

    [ObservableProperty]
    public partial int ConnectionTimeout { get; set; } = 0;

    [ObservableProperty]
    public partial bool EnableReordering { get; set; } = false;
    ...
    [ObservableProperty]
    public partial UpdatePolicy LauncherUpdatePolicy { get; set; } = UpdatePolicy.Never;
