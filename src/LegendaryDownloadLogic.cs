...
public class LegendaryDownloadLogic : IUnifiedDownloadLogic
{
    ...
    public async Task DownloadOtherThings(UnifiedDownload downloadTask)
    {
        ...
        try
        {
            ...
            await foreach (var cmdEvent in cmd.ListenAsync(Encoding.Default, Encoding.Default,
                               forcefulInstallerCts!.Token, gracefulInstallerCts!.Token))
            {
                switch (cmdEvent)
                {
                    ...
                    case StandardErrorCommandEvent stdErr:
                        ...
                        {
                            var installSizeNumber = CommonHelpers.ToBytes(
                        ...
                        {
                            var downloadedNumber = CommonHelpers.ToBytes(
