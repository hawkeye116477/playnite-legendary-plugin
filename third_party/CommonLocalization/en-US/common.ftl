...
common-max-workers = Maximum number of parallel tasks
...
common-revert-migrate-games = Migrate all games to { $originalPluginShortName } plugin
common-revert-migrating-games = Migrating all games to { $originalPluginShortName } plugin...
