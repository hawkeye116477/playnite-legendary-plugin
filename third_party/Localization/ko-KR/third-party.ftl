...
third-party-playnite-copy-title = 복사
third-party-playnite-import-label = 가져오기
...
third-party-playnite-settings-clear-cache-title = 캐시를 삭제하시겠습니까?
...
third-party-playnite-updater-window-title = 업데이트 사용 가능
third-party-playnite-updater-install-update = 업데이트 다운로드 및 설치
third-party-playnite-check-for-updates = 업데이트 확인
third-party-playnite-update-check-fail-message = 새로운 버전 확인에 실패했습니다.
third-party-playnite-install-game = 설치
third-party-playnite-uninstall-game = 설치 제거
third-party-playnite-client-not-installed-error = { $var0 } 클라이언트가 설치되지 않았습니다.
third-party-playnite-dont-show-again-title = 다시 표시 안함
third-party-playnite-common-links-store-page = 상점 페이지
third-party-playnite-extensions-updates = 업데이트
third-party-playnite-select-file-tooltip = 파일 선택...
third-party-playnite-select-directory-tooltip = 폴더 선택...
third-party-playnite-option-only-manually = 수동으로만
...
third-party-playnite-unsaved-changes-ask-message = 변경 사항을 저장하시겠습니까?
third-party-epic-settings-import-installed-label = 설치된 게임 가져오기
third-party-epic-settings-import-uninstalled-label = 설치되지 않은 게임 가져오기
third-party-epic-settings-connect-account = 계정 연결
third-party-epic-login-checking = 인증 상태 확인하는 중…
third-party-epic-not-logged-in = 인증이 필요함
third-party-epic-not-logged-in-error = 사용자 인증에 실패하였습니다.
third-party-epic-authenticate-label = 인증
third-party-epic-trouble-shooting-issues = 문제 해결
third-party-epic-start-using-client = { $var0 } 클라이언트 사용 시작
