...
third-party-playnite-version-label = 버전
...
third-party-playnite-settings-playtime-import-mode = 플레이 시간 가져오기:
third-party-playnite-settings-playtime-import-mode-always = 항상 가져오기
third-party-playnite-settings-playtime-import-mode-new-imports-only = 새로운 게임을 가져올 때만
...
third-party-playnite-game-launching = 시작 중
