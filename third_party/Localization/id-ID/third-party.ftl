...
third-party-playnite-copy-title = Salin
third-party-playnite-import-label = Impor
...
third-party-playnite-yes-label = Ya
...
third-party-playnite-settings-clear-cache-title = Bersihkan Cache?
...
third-party-playnite-updater-window-title = Update Tersedia
third-party-playnite-updater-install-update = Install Update
third-party-playnite-check-for-updates = Periksa Pembaruan
third-party-playnite-update-check-fail-message = Gagal memeriksa pembaruan.
third-party-playnite-install-game = Instal
third-party-playnite-uninstall-game = Uninstal
third-party-playnite-client-not-installed-error = { $var0 } klien belum terpasang.
third-party-playnite-dont-show-again-title = Jangan Tampilkan Lagi
third-party-playnite-common-links-store-page = Laman Toko
third-party-playnite-extensions-updates = Pembaruan
third-party-playnite-select-file-tooltip = Pilih file…
third-party-playnite-select-directory-tooltip = Pilih folder…
third-party-playnite-option-only-manually = Hanya secara manual
...
third-party-epic-login-checking = Mengecek status autentikasi…
third-party-epic-not-logged-in = Memerlukan autentikasi
third-party-epic-not-logged-in-error = Gagal mengautentikasi pengguna
third-party-epic-authenticate-label = Autentikasi
third-party-epic-trouble-shooting-issues = Memecahkan masalah
third-party-epic-start-using-client = Mulai menggunakan klien { $var0 }
