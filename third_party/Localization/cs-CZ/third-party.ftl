...
third-party-playnite-settings-playtime-import-mode = Importovat dobu hraní her v knihovně:
third-party-playnite-settings-playtime-import-mode-always = Vždy
third-party-playnite-settings-playtime-import-mode-new-imports-only = Pouze pro nově importované
