...
third-party-playnite-copy-title = Kopírovat
third-party-playnite-import-label = Importovat
...
third-party-playnite-client-not-installed-error = Klient { $var0 } není nainstalován.
...
third-party-playnite-unsaved-changes-ask-message = Chcete uložit provedené změny?
third-party-epic-settings-import-installed-label = Importovat nainstalované hry
third-party-epic-settings-import-uninstalled-label = Importovat neinstalované hry
third-party-epic-settings-connect-account = Připojit účet
third-party-epic-login-checking = Ověřuji stav přihlášení…
third-party-epic-not-logged-in = Vyžaduje přihlášení
third-party-epic-not-logged-in-error = Přihlášení se nezdařilo.
third-party-epic-authenticate-label = Autentizovat
third-party-epic-trouble-shooting-issues = Řešení potíží
third-party-epic-start-using-client = Začít používat { $var0 } klienta.
