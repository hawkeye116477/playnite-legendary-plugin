...
third-party-playnite-version-label = Έκδοση
...
third-party-playnite-settings-playtime-import-mode = Εισαγωγή χρόνου παιχνιδιού στη βιβλιοθήκη:
third-party-playnite-settings-playtime-import-mode-always = Πάντα
third-party-playnite-settings-playtime-import-mode-new-imports-only = Μόνο για τα νεοεισαχθέντα παιχνίδια
