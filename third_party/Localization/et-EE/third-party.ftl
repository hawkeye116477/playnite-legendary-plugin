...
third-party-playnite-settings-playtime-import-mode = Impordi teegis olevate mängude mänguaeg:
third-party-playnite-settings-playtime-import-mode-always = Alati
third-party-playnite-settings-playtime-import-mode-new-imports-only = Ainult äsja imporditud mängudel
