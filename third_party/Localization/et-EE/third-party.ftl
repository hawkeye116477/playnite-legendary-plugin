...
third-party-playnite-copy-title = Kopeeri
third-party-playnite-import-label = Impordi
...
third-party-playnite-yes-label = Jah
...
third-party-playnite-settings-clear-cache-title = Tühjenda vahemälu?
...
third-party-playnite-check-for-updates = Otsi värskendusi
...
third-party-playnite-client-not-installed-error = Klient { $var0 } pole installitud.
...
third-party-playnite-select-file-tooltip = Vali fail…
third-party-playnite-select-directory-tooltip = Vali kaust…
third-party-playnite-option-only-manually = Ainult käsitsi
...
third-party-epic-login-checking = Autentimise oleku kontrollimine…
third-party-epic-not-logged-in = Vajalik on autentimine
third-party-epic-not-logged-in-error = Kasutaja autentimine ebaõnnestus.
third-party-epic-authenticate-label = Autendi
third-party-epic-trouble-shooting-issues = Probleemide tõrkeotsing
third-party-epic-start-using-client = Käivita klienti { $var0 } kasutades
