...
third-party-playnite-settings-playtime-import-mode = Импортировать время игры в библиотеку:
third-party-playnite-settings-playtime-import-mode-always = Всегда
third-party-playnite-settings-playtime-import-mode-new-imports-only = Только для недавно импортированных игр
...
third-party-playnite-game-launching = Запускается
