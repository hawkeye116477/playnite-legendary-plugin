...
third-party-playnite-game-start-error = Не удалось запустить игру: { $var0 }
...
third-party-playnite-copy-title = Копировать
third-party-playnite-import-label = Выбрать
...
third-party-playnite-no-label = Нет
third-party-playnite-downloading-label = Скачивание…
...
third-party-playnite-settings-clear-cache-title = Очистить кэш?
...
third-party-playnite-check-for-updates = Проверить наличие обновлений
...
third-party-playnite-client-not-installed-error = Клиент { $var0 } не установлен.
...
third-party-playnite-select-file-tooltip = Выбрать файл…
third-party-playnite-select-directory-tooltip = Выбрать папку…
third-party-playnite-option-only-manually = Только вручную
third-party-playnite-option-once-a-day = Раз в день
third-party-playnite-option-once-a-week = Раз в неделю
third-party-playnite-open = Открыть
third-party-playnite-unsaved-changes-ask-message = Сохранить сделанные вами изменения?
third-party-epic-settings-import-installed-label = Импортировать установленные игры
third-party-epic-settings-import-uninstalled-label = Импортировать неустановленные игры
third-party-epic-settings-connect-account = Подключить аккаунт
third-party-epic-login-checking = Проверка статуса аутентификации…
third-party-epic-not-logged-in = Требуется авторизация
third-party-epic-not-logged-in-error = Не удалось авторизовать пользователя.
third-party-epic-authenticate-label = Аутентификация
third-party-epic-trouble-shooting-issues = Устранение неполадок
third-party-epic-start-using-client = Запустить через клиент { $var0 }
