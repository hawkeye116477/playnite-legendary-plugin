...
third-party-playnite-settings-playtime-import-mode = 导入库中游戏的游玩时间：
third-party-playnite-settings-playtime-import-mode-always = 总是
third-party-playnite-settings-playtime-import-mode-new-imports-only = 仅新导入
