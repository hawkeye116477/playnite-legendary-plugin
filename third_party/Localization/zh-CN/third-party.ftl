...
third-party-playnite-copy-title = 复制
third-party-playnite-import-label = 导入
...
third-party-playnite-progress-metadata = 正在下载资料数据…
...
third-party-playnite-settings-clear-cache-title = 清除缓存？
...
third-party-playnite-updater-install-update = 下载并安装更新
third-party-playnite-check-for-updates = 检查更新
third-party-playnite-update-check-fail-message = 检查新版本失败。
third-party-playnite-install-game = 安装
third-party-playnite-uninstall-game = 卸载
third-party-playnite-client-not-installed-error = { $var0 } 客户端未安装。
third-party-playnite-dont-show-again-title = 不再显示
third-party-playnite-common-links-store-page = 商店页面
third-party-playnite-extensions-updates = 更新
third-party-playnite-select-file-tooltip = 选择文件…
third-party-playnite-select-directory-tooltip = 选择文件夹…
third-party-playnite-option-only-manually = 仅手动
third-party-playnite-option-once-a-day = 每天一次
third-party-playnite-option-once-a-week = 每周一次
third-party-playnite-open = 打开
third-party-playnite-unsaved-changes-ask-message = 您想要保存您所作的更改吗？
third-party-epic-settings-import-installed-label = 导入已安装的游戏
third-party-epic-settings-import-uninstalled-label = 导入未安装的游戏
third-party-epic-settings-connect-account = 连接账户
third-party-epic-login-checking = 正在检查身份认证状态…
third-party-epic-not-logged-in = 需要身份认证
third-party-epic-not-logged-in-error = 用户身份验证失败。
third-party-epic-authenticate-label = 身份验证
third-party-epic-trouble-shooting-issues = 疑难解答
third-party-epic-start-using-client = 使用 { $var0 } 客户端启动
