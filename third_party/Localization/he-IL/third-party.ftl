...
third-party-playnite-settings-playtime-import-mode = ייבוא זמן משחק של משחקים בספריה:
third-party-playnite-settings-playtime-import-mode-always = תמיד
third-party-playnite-settings-playtime-import-mode-new-imports-only = רק עבור משחקים מיובאים חדשים
