...
third-party-playnite-copy-title = Sao chép
third-party-playnite-import-label = Nhập
...
third-party-playnite-yes-label = Có
...
third-party-playnite-progress-metadata = Đang tải xuống Siêu dữ liệu...
...
third-party-playnite-settings-clear-cache-title = Xóa bộ nhớ cache?
...
third-party-playnite-updater-install-update = Tải xuống và cài đặt bản cập nhật
third-party-playnite-check-for-updates = Kiểm Tra Cập Nhật
third-party-playnite-update-check-fail-message = Không thể kiểm tra phiên bản mới.
third-party-playnite-install-game = Cài đặt
third-party-playnite-uninstall-game = Gỡ cài đặt
third-party-playnite-client-not-installed-error = Ứng dụng khách { $var0 } chưa được cài đặt.
third-party-playnite-dont-show-again-title = Không hiện thị lại
third-party-playnite-common-links-store-page = Trang cửa hàng
third-party-playnite-extensions-updates = Cập nhật
third-party-playnite-select-file-tooltip = Chọn tập tin…
third-party-playnite-select-directory-tooltip = Chọn thư mục…
third-party-playnite-option-only-manually = Chỉ chạy thủ công
...
third-party-epic-not-logged-in-error = Không xác thực được người dùng.
third-party-epic-authenticate-label = Xác thực
third-party-epic-trouble-shooting-issues = Khắc phục sự cố
third-party-epic-start-using-client = Bắt đầu sử dụng ứng dụng khách { $var0 }
