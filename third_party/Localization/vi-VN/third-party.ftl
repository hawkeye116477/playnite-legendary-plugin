...
third-party-playnite-version-label = Phiên bản
...
third-party-playnite-settings-playtime-import-mode = Nhập thời gian chơi của game vào thư viện:
third-party-playnite-settings-playtime-import-mode-always = Luôn luôn
third-party-playnite-settings-playtime-import-mode-new-imports-only = Chỉ dành cho trò chơi mới được thêm vào
