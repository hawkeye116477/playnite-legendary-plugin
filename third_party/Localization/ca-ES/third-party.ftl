...
third-party-playnite-settings-playtime-import-mode = Importar temps de joc dels jocs de la biblioteca:
third-party-playnite-settings-playtime-import-mode-always = Sempre
third-party-playnite-settings-playtime-import-mode-new-imports-only = Només pels jocs recentment importats
