...
third-party-playnite-copy-title = Másolás
third-party-playnite-import-label = Importálás
...
third-party-playnite-client-not-installed-error = { $var0 } kliens nincs telepítve.
...
third-party-epic-login-checking = Hitelesítés ellenőrzése…
third-party-epic-not-logged-in = Felhasználói hitelesítés szükséges.
third-party-epic-not-logged-in-error = Felhasználói hitelesítés sikertelen.
third-party-epic-authenticate-label = Bejelentkezés
third-party-epic-trouble-shooting-issues = Hibaelhárítás
third-party-epic-start-using-client = { $var0 } használata
