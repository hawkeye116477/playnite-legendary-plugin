...
third-party-playnite-copy-title = Копирај
third-party-playnite-import-label = Увези
...
third-party-playnite-client-not-installed-error = { $var0 } клијент није инсталиран.
...
third-party-playnite-unsaved-changes-ask-message = Да ли желите да сачувате промене које сте направили?
third-party-epic-settings-import-installed-label = Увези инсталиране игре
third-party-epic-settings-import-uninstalled-label = Увези неинсталиране игре
third-party-epic-settings-connect-account = Повежи налог
third-party-epic-login-checking = Проверавање статуса аутентификације...
third-party-epic-not-logged-in = Захтева аутентификацију
third-party-epic-not-logged-in-error = Неуспешна аутентификација корисника
third-party-epic-authenticate-label = Аутентификуј
third-party-epic-trouble-shooting-issues = Решавање проблема
third-party-epic-start-using-client = Крени користити клијент { $var0 }
