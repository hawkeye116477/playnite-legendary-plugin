...
third-party-playnite-copy-title = कॉपी करा
third-party-playnite-import-label = आयात करा
third-party-playnite-version-label = आवृत्ती
...
third-party-playnite-yes-label = होय
...
third-party-playnite-progress-metadata = मेटाडेटा डाउनलोड करत आहे…
...
third-party-playnite-settings-clear-cache-title = कॅश साफ करायचे का?
third-party-playnite-settings-playtime-import-mode = लायब्ररीतील गेम खेळलेल्याची कालावधी आयात करा:
third-party-playnite-settings-playtime-import-mode-always = नेहमीच
third-party-playnite-settings-playtime-import-mode-new-imports-only = फक्त अलीकडे आयात केलेल्या गेम्ससाठी
...
third-party-playnite-updater-install-update = अपडेट डाउनलोड करून स्थापित करा
third-party-playnite-check-for-updates = अपडेटकरीता तपासा
third-party-playnite-update-check-fail-message = नवीन आवृत्तीचा तपास घेण्यात अयशस्वी.
third-party-playnite-install-game = स्थापित करा
third-party-playnite-uninstall-game = विस्थापित करा
third-party-playnite-client-not-installed-error = { $var0 } हा क्लाएंट स्थापित नाही.
third-party-playnite-dont-show-again-title = पुन्हा दाखवू नका
third-party-playnite-common-links-store-page = दुकानाचे पृष्ठ
third-party-playnite-extensions-updates = अपडेट
third-party-playnite-select-file-tooltip = फाईल निवडा…
third-party-playnite-select-directory-tooltip = फोल्डर निवडा…
...
third-party-epic-not-logged-in-error = प्रयोक्ता प्रमाणित करता आला नाही.
third-party-epic-start-using-client = { $var0 } क्लाएंट वापरून सुरू करा
