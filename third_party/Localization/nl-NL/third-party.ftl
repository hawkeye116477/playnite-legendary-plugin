...
third-party-playnite-settings-playtime-import-mode = Importeer de speeltijd van spellen in de bibliotheek:
third-party-playnite-settings-playtime-import-mode-always = Altijd
third-party-playnite-settings-playtime-import-mode-new-imports-only = Alleen voor nieuw geïmporteerde spellen
