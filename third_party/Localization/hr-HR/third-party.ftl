...
third-party-playnite-copy-title = Kopiraj
third-party-playnite-import-label = Uvezi
...
third-party-playnite-settings-playtime-import-mode = Uvezi vrijeme igranja igara u biblioteci
third-party-playnite-settings-playtime-import-mode-always = Uvijek
third-party-playnite-settings-playtime-import-mode-new-imports-only = Samo za svježe uvezene igre
...
third-party-playnite-client-not-installed-error = { $var0 } klijent nije instaliran.
