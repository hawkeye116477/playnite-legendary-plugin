...
third-party-playnite-settings-playtime-import-mode = Importar tiempo de juego de juegos en la biblioteca:
third-party-playnite-settings-playtime-import-mode-always = Siempre
third-party-playnite-settings-playtime-import-mode-new-imports-only = Sólo para los juegos recién importados
