...
third-party-playnite-settings-playtime-import-mode = Import playtime of games in library:
third-party-playnite-settings-playtime-import-mode-always = Always
third-party-playnite-settings-playtime-import-mode-new-imports-only = Only for newly imported games
...
third-party-playnite-game-launching = Launching
