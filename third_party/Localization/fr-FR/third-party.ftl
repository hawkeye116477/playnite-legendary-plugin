...
third-party-playnite-game-start-error = Impossible de démarrer le jeu : { $var0 }
...
third-party-playnite-copy-title = Copier
...
third-party-playnite-yes-label = Oui
third-party-playnite-no-label = Non
third-party-playnite-downloading-label = Téléchargement...
...
third-party-playnite-settings-clear-cache-title = Vider le cache ?
...
third-party-playnite-check-for-updates = Mises à jour
...
third-party-playnite-client-not-installed-error = { $var0 } le client n'est pas installé.
...
third-party-playnite-select-file-tooltip = Sélectionner un fichier…
third-party-playnite-select-directory-tooltip = Sélectionner un dossier…
third-party-playnite-option-only-manually = Manuellement
third-party-playnite-option-once-a-day = Une fois par jour
third-party-playnite-option-once-a-week = Une fois par semaine
third-party-playnite-open = Ouvrir
third-party-playnite-unsaved-changes-ask-message = Voulez-vous enregistrer les modifications que vous avez apportées ?
third-party-epic-settings-import-installed-label = Importer les jeux installés
third-party-epic-settings-import-uninstalled-label = Importer les jeux non installés
third-party-epic-settings-connect-account = Connecter un compte
third-party-epic-login-checking = Vérification…
third-party-epic-not-logged-in = Statut : Authentification requise
third-party-epic-not-logged-in-error = Impossible de connecter l'utilisateur.
third-party-epic-authenticate-label = Connexion
third-party-epic-trouble-shooting-issues = Résolution des problèmes
third-party-epic-start-using-client = Lancer avec le client { $var0 }
