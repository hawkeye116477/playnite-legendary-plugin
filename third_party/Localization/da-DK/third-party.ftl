...
third-party-playnite-game-start-error = Kan ikke starte spillet: { $var0 }
...
third-party-playnite-downloading-label = Downloader…
...
third-party-epic-settings-import-installed-label = Importer installerede spil
third-party-epic-settings-import-uninstalled-label = Importer ikke installerede spil
third-party-epic-settings-connect-account = Forbind konto
third-party-epic-login-checking = Tjekker godkendelsesstatus…
third-party-epic-not-logged-in = Kræver verificering
third-party-epic-not-logged-in-error = Det lykkedes ikke at verificere brugeren
third-party-epic-authenticate-label = Verificering
third-party-epic-trouble-shooting-issues = Problemer med fejlfinding
third-party-epic-start-using-client = Begynd at bruge { $var0 } klient
