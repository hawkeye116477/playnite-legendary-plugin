...
third-party-playnite-settings-playtime-import-mode = Импортиране на време за игра на игри в библиотеката:
third-party-playnite-settings-playtime-import-mode-always = Винаги
third-party-playnite-settings-playtime-import-mode-new-imports-only = Само за новоимпортирани игри
