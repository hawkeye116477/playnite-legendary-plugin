...
third-party-playnite-import-label = Импортирай
...
third-party-epic-settings-connect-account = Свързване на акаунт
...
third-party-epic-start-using-client = Започнете да използвате { $var0 } клиент
