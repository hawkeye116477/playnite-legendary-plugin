...
third-party-playnite-copy-title = Kopyala
third-party-playnite-import-label = İçe aktar
...
third-party-playnite-yes-label = Evet
...
third-party-playnite-settings-clear-cache-title = Önbelleği Temizle?
...
third-party-playnite-check-for-updates = Güncelleştirmeleri Denetle
...
third-party-playnite-client-not-installed-error = { $var0 } istemcisi kurulmamış.
...
third-party-playnite-select-file-tooltip = Dosya seç…
third-party-playnite-select-directory-tooltip = Klasör seç…
third-party-playnite-option-only-manually = Sadece el ile
...
third-party-epic-login-checking = Kimlik doğrulama durumu kontrol ediliyor…
third-party-epic-not-logged-in = Kimlik doğrulaması gerektiriyor
third-party-epic-not-logged-in-error = Kullanıcı kimliği doğrulanamadı.
third-party-epic-authenticate-label = Kimlik Doğrulaması
third-party-epic-trouble-shooting-issues = Sorunları giderme
third-party-epic-start-using-client = { $var0 } istemcisini kullanarak başlat
