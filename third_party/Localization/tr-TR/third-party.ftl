...
third-party-playnite-settings-playtime-import-mode = Kütüphanedeki oyunların oynanış sürelerini aktar:
third-party-playnite-settings-playtime-import-mode-always = Her zaman
third-party-playnite-settings-playtime-import-mode-new-imports-only = Sadece yeni aktarılan oyunlar için
...
third-party-playnite-game-launching = Başlatılıyor
