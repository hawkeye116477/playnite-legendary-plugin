...
###
third-party-playnite-filter-active-label = Filter je aktívny
...
third-party-playnite-copy-title = Kopírovať
third-party-playnite-import-label = Importovať
third-party-playnite-install-size-label = Veľkosť inštalácie
third-party-playnite-added-label = Pridané
...
third-party-playnite-progress-metadata = Preberajú sa metadáta…
third-party-playnite-menu-restart-system = Reštartovať systém
third-party-playnite-menu-shutdown-system = Vypnúť systém
...
third-party-playnite-settings-playtime-import-mode = Importovať čas strávený v hre do knižnice:
third-party-playnite-settings-playtime-import-mode-always = Vždy
third-party-playnite-settings-playtime-import-mode-new-imports-only = Iba pre novo naimportované hry
...
third-party-playnite-client-not-installed-error = Klient { $var0 } nie je nainštalovaný.
third-party-playnite-dont-show-again-title = Nabudúce nezobrazovať
third-party-playnite-common-links-store-page = Stránka v obchode
