...
third-party-playnite-settings-playtime-import-mode = ゲームのプレイ時間をライブラリにインポート:
third-party-playnite-settings-playtime-import-mode-always = 常に有効
third-party-playnite-settings-playtime-import-mode-new-imports-only = 新しくインポートされたゲームのみ
...
third-party-playnite-game-launching = 起動中
