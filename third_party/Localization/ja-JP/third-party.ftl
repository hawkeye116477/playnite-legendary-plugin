...
third-party-playnite-game-start-error = ゲームを開始できませんでした: { $var0 }
...
third-party-playnite-copy-title = コピー
third-party-playnite-import-label = インポート
...
third-party-playnite-yes-label = はい
...
third-party-playnite-settings-clear-cache-title = キャッシュをクリアしますか？
...
third-party-playnite-check-for-updates = 更新を確認
...
third-party-playnite-client-not-installed-error = { $var0 } クライアントがインストールされていません。
...
third-party-playnite-select-file-tooltip = ファイルを選択
third-party-playnite-select-directory-tooltip = フォルダを選択…
third-party-playnite-option-only-manually = 手動のみ
...
third-party-epic-login-checking = 認証ステータスを確認しています...
third-party-epic-not-logged-in = 認証が必要です
third-party-epic-not-logged-in-error = ユーザー認証に失敗しました。
third-party-epic-authenticate-label = 認証
third-party-epic-trouble-shooting-issues = 問題のトラブルシューティング
third-party-epic-start-using-client = { $var0 } クライアントの使用を開始
