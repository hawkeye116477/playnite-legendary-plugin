...
third-party-playnite-copy-title = Copiază
third-party-playnite-import-label = Importaţi
...
third-party-playnite-settings-clear-cache-title = Curățați Cache-ul?
third-party-playnite-settings-playtime-import-mode = Importă timpul jucat al jocurilor în bibliotecă:
third-party-playnite-settings-playtime-import-mode-always = Întotdeauna
third-party-playnite-settings-playtime-import-mode-new-imports-only = Doar pentru jocurile nou importate
...
third-party-playnite-check-for-updates = Verificați dacă sunt disponibile Actualizări
...
third-party-epic-login-checking = Se verifică starea de autentificare...
third-party-epic-not-logged-in = Necesită autentificare
third-party-epic-not-logged-in-error = Autentificare eșuată.
third-party-epic-authenticate-label = Autentificați-vă
third-party-epic-trouble-shooting-issues = Probleme de depanare
third-party-epic-start-using-client = Începeți să folosiți clientul { $var0 }
