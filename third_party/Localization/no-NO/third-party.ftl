...
third-party-playnite-copy-title = Kopier
third-party-playnite-import-label = Importer
...
third-party-playnite-progress-metadata = Laster ned metadata …
...
third-party-playnite-settings-clear-cache-title = Tøm hurtigminne?
...
third-party-playnite-uninstalling = Avinstallerer
third-party-playnite-do-nothing = Gjør ingenting
third-party-playnite-close = Lukk
third-party-playnite-updater-window-title = Oppdatering er tilgjengelig
third-party-playnite-updater-install-update = Last ned og installer oppdatering
third-party-playnite-check-for-updates = Se etter oppdateringer
third-party-playnite-update-check-fail-message = Oppdateringssjekk mislyktes.
third-party-playnite-install-game = Installer
third-party-playnite-uninstall-game = Avinstaller
third-party-playnite-client-not-installed-error = { $var0 }-klient er ikke installert.
third-party-playnite-dont-show-again-title = Ikke vis igjen
third-party-playnite-common-links-store-page = Butikkside
third-party-playnite-extensions-updates = Oppdateringer
third-party-playnite-select-file-tooltip = Velg fil …
third-party-playnite-select-directory-tooltip = Velg mappe …
third-party-playnite-option-only-manually = Bare manuelt
...
third-party-playnite-unsaved-changes-ask-message = Vil du lagre endringene du har gjort?
third-party-epic-settings-import-installed-label = Importer installerte spill
third-party-epic-settings-import-uninstalled-label = Importer spill som ikke er installert
third-party-epic-settings-connect-account = Tilknytt konto
third-party-epic-login-checking = Kontrollerer autentiseringsstatus …
third-party-epic-not-logged-in = Krever autentisering
third-party-epic-not-logged-in-error = Brukerautentisering mislyktes.
third-party-epic-authenticate-label = Autentiser
third-party-epic-trouble-shooting-issues = Feilsøking av problemer
third-party-epic-start-using-client = Begynn å bruke { $var0 }-klient
