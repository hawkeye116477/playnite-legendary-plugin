...
third-party-playnite-version-label = Versjon
...
third-party-playnite-settings-playtime-import-mode = Importer spilletid for spill i biblioteket:
third-party-playnite-settings-playtime-import-mode-always = Alltid
third-party-playnite-settings-playtime-import-mode-new-imports-only = Bare for nylig importerte spill
