...
third-party-playnite-settings-playtime-import-mode = Spielzeit von Spielen der Bibliothek importieren:
third-party-playnite-settings-playtime-import-mode-always = Immer
third-party-playnite-settings-playtime-import-mode-new-imports-only = Nur für neu importierte Spiele
