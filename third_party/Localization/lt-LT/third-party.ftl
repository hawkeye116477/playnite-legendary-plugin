...
third-party-playnite-game-start-error = Nepavyko paleisti žaidimo: { $var0 }
...
third-party-playnite-copy-title = Kopijuoti
third-party-playnite-import-label = Įtraukti
...
third-party-playnite-yes-label = Taip
third-party-playnite-no-label = Ne
third-party-playnite-downloading-label = Siunčiama…
...
third-party-playnite-settings-clear-cache-title = Išvalyti Talpyklą?
third-party-playnite-settings-playtime-import-mode = Importuoti žaidimo laika iš bibliotekos:
third-party-playnite-settings-playtime-import-mode-always = Visada
third-party-playnite-settings-playtime-import-mode-new-imports-only = Tik neseniai importuotiem žaidimam
...
third-party-playnite-check-for-updates = Tikrinti, ar yra atnaujinimų
...
third-party-playnite-client-not-installed-error = { $var0 } klientas yra neįdiegtas.
...
third-party-epic-settings-import-installed-label = Importuoti įdiegtus žaidimus
third-party-epic-settings-import-uninstalled-label = Importuoti neįdiegtus žaidimus
third-party-epic-settings-connect-account = Susieti paskyrą
third-party-epic-login-checking = Tikrinama autentifikavimo būsena...
third-party-epic-not-logged-in = Reikalinga autentifikavimas
third-party-epic-not-logged-in-error = Nepavyko autentifikuoti vartotojo.
third-party-epic-authenticate-label = Autentifikuoti
third-party-epic-trouble-shooting-issues = Tvarkoma klaidas
third-party-epic-start-using-client = Pradėti naudojant { $var0 } klientą
